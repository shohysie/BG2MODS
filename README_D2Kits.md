<div align="center"><h1></a>Diablo2 Kit Pack Series v230326</h1>
...
>----------ATTENTIONS----------
  ...
  *If you do press a "Skill Point" at skill table but then close the arisen skills table without making a choice, the "Skill Point" does nothing by get wasted!
  ...
  Decoys and Valkyries do not occupy the limited quantity of summoned units, but they can't be summoned if the summoning cap is already achieved. When the Valkyrie is imprisoned or petrified, a reverse magic is required to free her, or else she can't be summoned again.
...
V0.6  A new component that removes the artificial limit of regular summoned creatures from the game.
  Fixed the problem that vines, spirits and grizzly bear don't behave normally in a Black Pits 2 game. When some other similar problems occur, a party rest may solve them.
  Pressing V makes vines visible, then a successful attack or being struck makes them invisible again.
  Cyclone Armor ignores Dispel Magic and Pierce Magic, etc. but can be removed by Breach. 
  Adjusted the aura of Oak Sage to 8 Maximum HP for every 2 Druid levels.
  Pressing F forces overlapped summoned creatures to step out.
  Fixed the wrong life value of aura of Oak Sage at low level.
  Fixed the problem that Transformed Feats may not work.
  Increased compatibility for EE mods.
  Fixed the animation of Tornado.
  Solved this problem that Molten Boulder, Twister and Tornado may not be able to take effect with increased casting speed.
...
Diablo2 Kit Pack - The Necromancer Ver 0.9</a><br>

>----------ATTENTIONS----------

    It is a Cleric kit for BG2, BGT and EE series, restricted to Human, Elf, Half-elf and Gnome.
    ...
    Golems and Bone Walls do not occupy the limited quantity of summoned units, but they can't be summoned if the summoning cap is already achieved (the component 'Remove Summoning Cap for Regular Summons' would help). If one golem is imprisoned or petrified, a reverse magic is required to free it, or else another golem can't be summoned.
    Pressing F forces overlapped summoned creatures to step out.

    The component 'Survived monsters follow the Necromancer through different areas' makes all revived creatures able to follow the summoner across different areas, but may cause lags and bigger non-EE games save files, which is not recommended when a certain amount of other MOD has been installed.

    As a cleric's weapon proficiency points overflow at high level, which prevents him from getting High-level skills, the Necromancer automatically losses his Single Weapon Skill before level 35, 40, 45 and 50 to ensure normal level-up.

>----------KNOWN BUGS----------

    On some special areas, e.g. the third level of Watcher's Keep or Staging Area in Black Pits 2, Golems may be lost behind or give strange performance. Try go back to bring them along, or summon another one after having a rest.
...
V0.9 A new component that removes the artificial limit of regular summoned creatures from the game. 
     Fixed the problem that Golems don't behave normally in a Black Pits 2 game. When some other similar problems occur, a party rest may solve them.
     Iron Golem can be summoned from 2 more runewords: Exile and Last Wish.
     Modified the Kit Races restriction to Human, Elf, Half-elf and Gnome.
     Fixed the class level and weapon enchantment level of Skeletons.
     Pressing F forces overlapped summoned creatures to step out.
     Bone Spear can be casted on any point instead of a creature.
     Increased compatibility for EE mods.
...
Diablo2 Kit Pack - The Paladin Ver 1.2</a><br>

>----------ATTENTIONS----------

  It is a Paladin kit for BG2, BGT and EE series, restricted to Human only. 

  Paladin gains various auras at different levels. The auras, which take effect each round, can be switched freely.
  Auras against the enemy need to be actually triggered by an enemy in the Paladin's sight. Auras for the whole team immediately take effect for 1 round when activated, then the area effects need to be triggered by anyone within 50' of the Paladin (10' for no EE games), otherwise their effects only effect the Paladin himself. Exceptions: Meditation, Redemption and Thorns actually work on battle, they only give visual effects in normal times, because the former two Auras are too powerful, and the last Aura may cause problems on cutscenes, etc.
...
-  May not turn Undead.
-  Only can put one slot on single weapon, two weapon and two handed styles.
...
This aura gives all party members ability of regeneration. Required Level: 1
  LV1: regenerates 2 HP/round; LV4: regenerates 4 HP/round; LV8: regenerates 6 HP/round; LV12: regenerates 8 HP/round.
...
This aura increases the fire resistance of all party members. Required Level: 1
  LV1: +45% Fire resistance; LV4: +60% Fire resistance; LV8: +75% Fire resistance; LV12: +90% Fire resistance.
...
This aura increases the cold resistance of all party members. Required Level: 4
  LV4: +45% Cold resistance; LV8: +60% Cold resistance; LV12: +75% Cold resistance; LV16: +90% Cold resistance.
...
This aura increases the lightning resistance of all party members. Required Level: 8
  LV8: +45% Lightning resistance; LV12: +60% Lightning resistance; LV16: +75% Lightning resistance; LV20: +90% Lightning resistance.
...
This aura boosts the defense against all 4 types of weapons (Crushing, Missile, Piercing and Slashing) for all party members. Required Level: 4
  LV4: +4 Bonus to all AC types; LV8: +6 Bonus to all AC types; LV12: +8 Bonus to all AC types; LV16: +10 Bonus to all AC types.
...
This aura increase acid and poison resistance of all party members (poison resistance only exists in EE games). It can also cure poison, disease, and remove cursed items. Required Level: 8
  LV8: +45% Acid and Poison resistance; LV12: +60% Acid and Poison resistance; LV16: +75% Acid and Poison resistance; LV20: +90% Acid and Poison resistance.
...
This aura increases moving speed, grants immunity of Slow and Hold, and reduces fatigue for all party members. Required Level: 12
  LV12: +5 to Speed; LV16: +6 to Speed; LV20: +7 to Speed; LV24: +8 to Speed.
...
This aura restores a casted spell per round for all party members, and also gives ability of regeneration as Prayer casted by a Paladin with a half level of the caster. Required Level: 16
  LV16: spell of level 1-3; LV20: spell of level 1-5; LV24: priest spell of level 1-6, wizard spell of level 1-7;  LV28: priest spell of level 1-7, wizard spell of level 1-9.
...
This aura increases Elemental resistances against Fire, Cold, Lightning, Acid and Poison for all party members (poison resistance only exists in EE games). High-Level skill.
...
This aura increases damage dealt by party members. Required Level: 1
  LV1: +2 damage; LV4: +4 damage; LV8: +6 damage; LV12: +8 damage.
...
This aura periodically does Fire damage to enemies in 30', and also attaches Fire damage on Paladin's weapon. Required Level: 4
  LV4: 2D3 fire damage to enemies in 30', +2D6 fire damage on hit; LV8: 3D3 fire damage to enemies in 30', +3D6 fire damage on hit; LV12: 4D3 fire damage to enemies in 30', +4D6 fire damage on hit; LV16: 5D3 fire damage to enemies in 30', +5D6 fire damage on hit.
...
This aura causes enemies to take piercing damage when they cause melee damage to party members. Required Level: 4
  LV4: 2D6 damage; LV8: 4D6 damage; LV12: 6D6 damage; LV16: 8D6 damage.
...
This aura brings bonus to THAC0. Required Level: 8
  LV8: +5 bonus to THAC0; LV12: +7 bonus to THAC0; LV16: +9 bonus to THAC0; LV20: +11 bonus to THAC0.
...
This aura increases attack damage and provides a certain probability to remove and give protection against negative mental effects each round. Required Level: 12
  LV12: +4 damage, 20% chance of treating mental effects; LV16: +6 damage, 30% chance of treating mental effects; LV20: +8 damage, 40% chance of treating mental effects; LV24: +10 damage, 50% chance of treating mental effects.
...
This aura periodically damages and slows enemies in 30' (similar to reception of a Slow spell), and also attaches Cold damage on Paladin's weapon. Required Level: 12
  LV12: 1D2 cold damage to enemies in 30', +2D2 cold damage on hit; LV16: 2D2 cold damage to enemies in 30', +4D2 cold damage on hit; LV20: 3D2 cold damage to enemies in 30', +6D2 cold damage on hit; LV24: 4D2 cold damage to enemies in 30', +8D2 cold damage on hit.
...
This aura periodically does Lightning damage to enemies in 30', and also attaches Lightning damage on Paladin's weapon. Required Level: 16
  LV16: 1D14 Lightning damage to enemies in 30', +2D14 Lightning damage on hit; LV20: 1D16 Lightning damage to enemies in 30', +2D16 Lightning damage on hit; LV24: 1D18 Lightning damage to enemies in 30', +2D18 Lightning damage on hit; LV28: 1D20 Lightning damage to enemies in 30', +2D20 Lightning damage on hit.
...
This aura damages and does knockback to hostile Undead in 30', and also enhances Paladin's attacks vs. Undead. Required Level: 16
  LV16: 2D4 damage to Undead in 30', and +9 damage on hit vs. Undead; LV20: 2D6 damage to Undead in 30', and +12 damage on hit vs. Undead; LV24: 2D8 damage to Undead in 30', and +15 damage on hit vs. Undead; LV28: 2D10 damage to Undead in 30', and +18 damage on hit vs. Undead.
...
This aura increases attack rate of +1 attack per round, and brings bonus to THAC0 and damage for all party members. The Paladin himself gets more damage bonus than his partners. High-Level skill.
  Before LV25: +2 bonus to THAC0 and +3 to damage for party members, +6 damage to the Paladin; LV25: +3 bonus to THAC0 and +4 to damage for party members, +8 damage to the Paladin; LV30: +4 bonus to THAC0 and +5 to damage for party members, +10 damage to the Paladin; LV35: +5 bonus to THAC0 and +6 to damage for party members, +12 damage to the Paladin; LV40: +6 bonus to THAC0 and +7 to damage for party members, +14 damage to the Paladin.
...
This skill increases damage at the cost of 8% health on each hit. Required Level: 1
  LV1: +9 damage, +3 bonus to THAC0; LV4: +12 damage, +4 bonus to THAC0; LV8: +15 damage, +5 bonus to THAC0; LV12: +18 damage, +6 bonus to THAC0; LV16: +21 damage, +7 bonus to THAC0.
...
This skill sends a shield bash that does damage and stuns the enemy fo 1 second, allowing the Paladin to pursue immediately wtih a next skill. Required Level: 1
  LV1: 2D4 damage; LV4: 3D4 damage; LV8: 4D4 damage; LV12: 5D4 damage; LV16: 6D4 damage.
...
This skill launches a bolt of energy that damages hostile Undead and Demons, or heals friendly units with HP as half of damages. Required Level: 4
  LV4: 4D6 damage; LV8: 6D6 damage; LV12: 8D6 damage; LV16: 10D6 damage.
...
This skill provides quick attacks on adjacent enemies. Required Level: 8
  LV8: Attack twice per round, +1 melee damage, +2 bonus to melee THAC0; LV12: Attack 3 times per round, +2 melee damage, +3 bonus to melee THAC0; LV16: Attack 4 times per round, +3 melee damage, +4 bonus to melee THAC0; LV20: Attack 5 times per round, +4 melee damage, +5 bonus to melee THAC0.
...
This ability causes the Paladin to close the distance with an enemy, delivering a bash on contact. The enemy is knocked back, which makes it easy for the Paladin to pursue with another skill immediately. The victim(s) may make a save vs. death in order to take only half damage. Required Level: 8
  LV8: 6D10 damage; LV12: 8D10 damage; LV16: 10D10 damage; LV20: 12D10 damage.
...
This skill adds Elemental (Fire, Lightning, Cold and Acid) damage to all melee attacks. Required Level: 12
  LV12: +1D4 to each elemental damage, +2 bonus to THAC0; LV16: +1D6 to each elemental damage, +3 bonus to THAC0; LV20: +1D8 to each elemental damage, +4 bonus to THAC0; LV24: +1D10 to each elemental damage, +5 bonus to THAC0.
...
This skill summons a hammer composed of magic power to fly towards the enemy, dealing considerable damage. Demons and undead take 50% extra damage, furthermore, the Undead must save vs. death with a certain penalty or be destroyed. Required Level: 12
  LV12: 6D6 damage, no save penalty; LV16: 6D8 damage, -2 save penalty; LV20: 6D10 damage, -4 save penalty; LV24: 6D12 damage, -6 save penalty.
...
This skill calls lightning attack from the sky that releases Holy Bolts (equivalent to Holy Bolts released by a Paladin with a half level of the caster). The victim(s) may make a save vs. death in order to take only half lightning damage. High-Level skill. 
  Before LV25: 12D8 damage; LV25: 14D8 damage; LV30: 16D8 damage; LV35: 18D8 damage; LV40: 20D8 damage.
...
V1.2  As a Paladin's level grows slower than other Classes, his skills now get improved for every 4 levels instead of 5.
  Concentration provides a certain probability to remove and give protection against negative mental effects each round.
  Ajusted skill values of Might, Blessed Aim, Defiance, Holy Fire, Holy Freeze, Holy Shock and Fist of the Heavens.
  Auras that afford protections for party members immediately take effect for 1 round when activated, then the area effects need to be triggered by anyone within 50' of the Paladin (10' for no EE games).
  Smite stuns a enemy for 1 second regardless of character level.
  Meditation has double effect on Diablo 2 Sorcerer Kit.
  Vigor provides immunity of Slow and Hold.
  Cleansing cures Disease as well as Poison.
...
Diablo2 Kit Pack - The Sorcerer Ver 0.5</a><br>

>----------ATTENTIONS----------

    It is a Sorcerer kit for EE games only, not for original BG series. The races available are restricted to Human, Elf and Half-elf.
    ...
    Any of the High-level skills can only be selected once each time you level up! For example, the Sorcerer gains two levels, and two 'Fire Mastery' are selected at the same time in the upgrade operation, then only one 'Fire Mastery' works.
    ...
    A hireling voluntarily takes one step away from the Sorcerer when they get too close, in order to avoid getting jammed when traveling across different areas. Pressing F also forces overlapped hireling to step out.
    You can speak with a hireling and give him some potion to drink.
    Hirelings do not occupy the limited quantity of summoned units, but they can't be summoned if the summoning cap is already achieved. If one hireling is imprisoned or petrified, a reverse magic should be casted to free him, or other hirelings can't be summoned.
...
>----------KNOWN BUGS----------
    ...
    On some special areas, e.g. the third level of Watcher's Keep or Staging Area in Black Pits 2, hirelings may be lost behind or give strange performance. Try go back to bring them along, or summon another one after party rest.
...
V0.5  Fixed the BUG that hireling may disappear when level up.
  Fixed the problem that hirelings don't behave normally in a Black Pits 2 game. When some other similar problems occur, a party rest may solve them.
  Fixed the BUG that Elly the archer does not cast Fire Arrow.
  Fixed the problem that effect of Enchant doesn't increase with level.
  Improved the casting frequency of Jarulf the mage, especially when he's equipping a shield of Spirit (Rune Word item, comes from interacting with Diablo 2 Item Store MOD).
  Energy Shield ignores Dispel Magic and Pierce Magic, etc. but can be removed by Breach. 
  New mechanism for Warmth, no longer needs any script.
  Pressing F forces overlapped hireling to step out.
  Fixed the retained BG2 spells for the Sorcerer.
  Increased compatibility for EE mods.
  Solved this problem that Frozen Orb may not be able to take effect with a greatly increased casting speed.
